---
layout: post
title:  "Sound Algorithm Study 9"
author: naoto
categories: [ sketch ]
tags: [ p5js, sound ]
image: assets/images/2020-01-02-sound-algorithm-study-9.png
...
const s = (p) => {
  ...
  let codeBase = `[30,40].synth(p).concat([20,30].synth(f)).repeat(2).concat('30~').repeat(4)`;
  let pastCommands = [];
  ...
  const unpack = (code) => {
    ...
    function looseJsonParse(obj) {
      ...
      let a='a';let f='f';let N='N';let p='p';let m='m';let s='~';let t='^';let q='['
      return (` + obj + ')')();
    }
