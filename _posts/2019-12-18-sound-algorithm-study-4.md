---
layout: post
title:  "Sound Algorithm Study 4"
author: naoto
categories: [ sketch ]
tags: [ p5js, sound ]
image: assets/images/2019-12-18-sound-algorithm-study-4.png
...
const s = (p) => {
  ...
  p.draw = () => {
    ...
    setColorMode = 0 + bangCycle;
    bangDur = 0.75;
    wipeDraws[(curPattern+1)%wipeDraws.length](pg2);
    setColorMode = 2 + bangCycle;
    bangDur = 1;
    wipeDraws[(curPattern+2)%wipeDraws.length](mix1.pg);
    setColorMode = 0;
