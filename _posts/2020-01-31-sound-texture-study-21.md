---
layout: post
title:  "Sound Texture Study 21"
author: naoto
categories: [ sketch ]
tags: [ p5js, sound ]
image: assets/images/2020-01-31-sound-texture-study-21.png
        ...
        switch (t) {
          ...
          case 'd':
            if (feedbackLoop.feedbackDelay) {
              feedbackLoop.feedbackDelay.delayTime.linearRampTo(1, 1 / 60);
              feedbackLoop.feedbackDelay.delayTime.linearRampTo(0.1, 1, 1 / 60);
              feedbackLoop.feedbackDelay.feedback.linearRampTo(0.7, 1 / 60);
              feedbackLoop.feedbackDelay.feedback.linearRampTo(0.2, 1, 1 / 60);
            }
            break;
          case '+':
          case '-':
...
class FeedbackLoop {
  ...
  setup() {
    ...
    this.feedbackDelay = new Tone.FeedbackDelay(0.1, 0.2).connect(this.feedback);
